 ...
 * @version $Id: Result.java,v 1.27 2008/04/21 19:30:34 ntt Exp $
 */
public class Result {
    ...
    */
   public Result(String name, long size) {
      this(null, name, size, null);
   }
    ...
    * @param name the file's name.
    */
   public Result(Request request, String name) {
      this._request = request;
      this._fileName = name;
      this._timeStamp = DateTimeUtil.getTimestamp();
      if (this._request != null)
      {
          this._fileType      = this._request.getType();
    ...
    * @param size the size of the file in bytes.
    */
   public Result(Request request, String name, long size) {
      this(request, name, size, null);
   }
    ...
    */
   public Result(Request request, String name, long size, Date datetime) {
      this(request, name);      
      this._size = size;
    ...
    */
   public Result(Request request, int errno, String message) {
      this(request, null);
      this._errno = errno;
    ...
    */
   public Result(int ftId, String name, String contributor, long size,
    ...
    */
   public Result(String vft, String refName, String refLink,
    ...
    */
   public Result(String vft, String title, String comment, String createdBy,
    ...
    */
   public //void setRestartInfo(RestartInfo restartInfo) {
    ...
    * 
    * @param location the remote location of the file
    */
    ...
    * 
    * @return location of file on local system (if applicable)
    */
    ...
    * 
    * @param location the local location of the file
    */
   public final void setLocalLocation(String location) {
       this._localLocation = location;
   }
